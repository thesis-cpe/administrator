...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ของที่ระลึก
        <small>เพิ่ม ลบ แก้ไข ของที่ระลึก</small>
      </h1>
      <ol class="breadcrumb">
      <!--  <li><a href="#"><i class="fa fa-dashboard"></i> Level</a></li>
        <li class="active">Here</li>  -->
          <li><a href="add-product.php"><i class="fa fa- fa-plus"></i>เพิ่มรายการของที่ระลึก</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-xs-12">
            ...
            <?php include "./include/data_product.html";?>
         </div><!-- /.col-xs-12 -->
      </div><!-- /row -->
      <!-- .Your Page Content Here -->
