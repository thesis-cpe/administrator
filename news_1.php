...
{
   $("#includedSidebar").load("./include/sidebar.html");
   $("#includedNavbar").load("./include/navbar.html");
   $("#includedFooter").load("./include/footer.html");
}
function loadNavbar()
{
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        กิจกรรม
        <small>เพิ่ม ลบ แก้ไข กิจกรรม</small>
      </h1>
      <ol class="breadcrumb">
      <!--  <li><a href="#"><i class="fa fa-dashboard"></i> Level</a></li>
        <li class="active">Here</li>  -->
          <li><a href="add-activity.php"><i class="fa fa- fa-plus"></i>เพิ่มกิจกรรม</a></li>
      </ol>
    </section>
